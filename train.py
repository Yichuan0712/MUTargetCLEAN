        ...
        with autocast():
            ...
            if configs.supcon.apply and warm_starting:
                ...
                for i in range(len(pos_transformed)):
                    ...
                    __, __, projection_headP = tools['net'](encoded_seqP, pos_transformed[i][0], id_frags_listP, seq_frag_tupleP, pos_neg, warm_starting)
                ...
                for i in range(len(neg_transformed)):
                    ...
                    __, __, projection_headN = tools['net'](encoded_seqN, neg_transformed[i][0], id_frags_listN, seq_frag_tupleN, pos_neg, warm_starting)
